...
Interpret each record by its outcome and evidence. Planned, unfinished, and canceled changes do not prove implemented behavior. A completed change supports what was verified at the recorded state. A later modification can replace only part of that behavior; preserve unaffected criteria in the historical account. A superseding change's proposal alone does not prove that its replacement shipped. Resolve order or applicability through available revisions and implementation evidence, not numeric IDs or dates alone; account for relevant reverts and work on other branches.
