...
Current version: **0.7.2**. The philosophy and skills are experimental; their effectiveness still needs to be tested on real tasks.
...
There is no `init` skill in 0.7.2. Begin with a real task; records are created only when needed.
